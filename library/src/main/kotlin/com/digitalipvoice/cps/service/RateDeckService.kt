...
class RateDeckService {
    ...
    fun createRateDeckItemIfNotFound(name: String, carrierName: String, userId: Long, defaultRate: Float) = rateDeckRepository.findByUserIdAndNameAndCarrierAndIsDeletedFalse(userId, name, carrierName)
            ?: RateDeck(name, carrierName, userId, defaultRate)
