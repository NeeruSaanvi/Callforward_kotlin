...
class SMSMessageService {
     ...
     * Find by Id
     */
    fun findById(id:String) = repository.findByIdKt(id)

    /**
     * Get response messages for request id
     */
    fun findResponseMessage(requestId: String) = repository.findByRequestMessageIdAndIsClientMessageFalse(requestId)

    /**
     * Find request message
     */
    fun findRequestMessage(requestId: String) = repository.findByIdAndIsClientMessageTrue(requestId)
