...
class LcrReportDataRepositoryImpl : LcrReportDataRepositoryCustom {
    ...
    override fun searchLcrReportData(query: TableQuery): TableResult {
        ...
        // columns to select
        val cols = arrayOf("u.npa_nxx", "u.lcr_report_id", "u.min_carrier", "u.min_rate", "u.carrier_1", "u.carrier_2", "u.carrier_3", "u.carrier_4", "u.carrier_5")
        val table = " $table u"
    ...
    override fun searchLcrReportDataByReportId(query: TableQuery, reportId: Long): TableResult {
        ...
        val cols = arrayOf("u.lata", "u.state", "u.npa_nxx", "u.lcr_report_id", "u.min_carrier", "u.min_rate", "u.carrier_1", "u.carrier_2", "u.carrier_3", "u.carrier_4", "u.carrier_5")
