...
class LataNpanxxReport2Data3RepositoryImpl : LataNpanxxReport2Data3RepositoryCustom {
    @PersistenceContext
    private lateinit var em: EntityManager

    private val table = "lata_npanxx_report_2_data_3"

    override fun searchLataNpanxxReport2Data3ByReportId(query: TableQuery, reportId: Long): TableResult {
        // columns to select
