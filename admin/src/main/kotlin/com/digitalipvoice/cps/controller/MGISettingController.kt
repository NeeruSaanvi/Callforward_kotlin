...
class MGISettingController{
    ...
    @ResponseBody
    @PreAuthorize("isMgiEnabled() AND hasAnyAuthority('${Privilege.ReadSmsConnections}', '${Privilege.WriteSmsConnections}')")
    ...
    @ResponseBody
    @PreAuthorize("isMgiEnabled() AND hasAuthority('${Privilege.WriteSmsConnections}')")
    ...
    fun stopSomosConnections(): ResponseEntity<BaseResponse> {
        ...
        return ResponseEntity.ok(BaseResponse("Stop command sent."))
    }

    /**************************ID & Ro Matching*********************************/
    @PostMapping("/users/idro")
    @ResponseBody
    @PreAuthorize("isMgiEnabled() AND hasAnyAuthority('${Privilege.ReadIdRos}', '${Privilege.WriteIdRos}')")
    ...
    @ResponseBody
    @PreAuthorize("isMgiEnabled() AND hasAuthority('${Privilege.WriteIdRos}')")
