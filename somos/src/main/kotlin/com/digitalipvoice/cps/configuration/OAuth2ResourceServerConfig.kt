...
class OAuth2ResourceServerConfig: ResourceServerConfigurerAdapter() {
    ...
    override fun configure(http: HttpSecurity) {
        http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.IF_REQUIRED)
                ...
                .antMatchers("/connections").access("#oauth2.hasScope('admin')")  // This /connections api should be called from admin module, not somos module
                .antMatchers("/*").access("#oauth2.hasScope('somos')")
