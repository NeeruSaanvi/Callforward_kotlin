...
class SMSConnectionManager {
    ...
    fun getConnectionsDTO()  =
        handlers.map { SMSConnectionDTO().apply {
            this.port = it.port
            this.remoteAddr = it.server
            this.isConnected = it.isActive
            this.srcNodeName = it.sourceNodeName
            this.destNodeName = it.destinationNodeName
        } }
}