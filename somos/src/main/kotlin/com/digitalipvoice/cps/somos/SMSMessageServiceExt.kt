 ...
 */
fun SMSMessageService.getSomosResponse(requestId: String): SomosResponse? {
 ...
 * This function is old and should be deprecated, but used by cps-customer-frontend
 */
fun SMSMessageService.getSomosResponseNew(requestId: String): SomosResponseNew? {
    val message = findResponseMessage(requestId) ?: return null
    // returns response
...
fun SMSMessageService.getSomosResponseStandalone(requestId: String): SomosResponseStandalone {
